...
// Source: github.com/ilya-rusyanov/gophkeeper/internal/server/usecase/register (interfaces: Tokener)
//
// Generated by this command:
//
//	mockgen -package mock -destination ./mock/tokener.go . Tokener
//
